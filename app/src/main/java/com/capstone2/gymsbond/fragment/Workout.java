package com.capstone2.gymsbond.fragment;
...
import com.capstone2.gymsbond.DayActivity;
import com.capstone2.gymsbond.R;
import com.capstone2.gymsbond.RestDayActivity;
import com.capstone2.gymsbond.adapters.AllDayAdapter;
import com.capstone2.gymsbond.adapters.WorkoutData;
import com.capstone2.gymsbond.d;
import com.capstone2.gymsbond.database.DatabaseOperations;
import com.capstone2.gymsbond.e;
import com.capstone2.gymsbond.listners.RecyclerItemClickListener;
import com.capstone2.gymsbond.listners.RecyclerItemClickListener.onItemClickListener;

import com.capstone2.gymsbond.utils.AppUtilss;
import com.capstone2.gymsbond.utils.Constants;
...
public class Workout extends Fragment {
    ...
    public void b(int i) {
        new Builder(getActivity()).title("Confirm!").titleColor(ContextCompat.getColor(getActivity(), R.color.black)).content("Would you like to repeat this workout?").contentColor(ContextCompat.getColor
                (getActivity(), R.color.textColor)).positiveText("Yes").positiveColor
                (ContextCompat.getColor(getActivity(), R.color.colorAccent))
                .onPositive(new d(this, i)).negativeText("No")
...
//        getSupportActionBar().setDisplayShowTitleEnabled(false);
        ...
        this.percentScore1 = inflate.findViewById(R.id.percentScore);
        this.dayleft = inflate.findViewById(R.id.daysLeft);
        ...
        for (int i = 0; i < Constants.TOTAL_DAYS; i++) {
            ...
            Double.isNaN(progress);
            this.k = (float) (d + ((progress * 4.348d) / 100.0d));
        ...
        this.recyclerView = inflate.findViewById(R.id.recycler);
...
//        this.manager = new GridLayoutManager(getActivity(), 3);
        ...
        this.recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(getActivity(), new onItemClickListener() {
            public void OnItem(View view, int i) {
                ...
                } else if (Workout.this.workoutDataList.get(i).getProgress() < 99.0f) {
                    intent = new Intent(getContext(), DayActivity.class);
                    intent.putExtra("day", Workout.this.arr.get(i));
                    intent.putExtra("day_num", i);
                    intent.putExtra("progress", Workout.this.workoutDataList.get(i).getProgress());
                } else {
                    Workout.this.b(i);
                    return;
                }
